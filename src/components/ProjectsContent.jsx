...
import imageTest from '../assets/hammer.svg';
import imageEELS from '../assets/EELS.svg';
  ...
  return (
    <div>
      <div className="project-box" onClick={() => toggleVisibility('eels')}>
        ...
        {isVisible.eels && (
          <div className="project-section">
            ...
            <img src={imageEELS} alt="EELS Project Icon" />
            <p>
      ...
      <div className="project-box" onClick={() => toggleVisibility('sroc')}>
        ...
        {isVisible.sroc && (
          <div className="project-section">
            <p>The <a href='https://www.esa.int/ESA_Multimedia/Images/2020/04/SROC'>Space Rider Observer Cube</a> 
            is a European Space Agency funded project building a small satellite to observe and dock with the Space Rider vehicle. 
            </p>
            <img src={imageTest} alt="SROC Project Icon" />
      ...
      <div className="project-box" onClick={() => toggleVisibility('mppd')}>
        ...
        {isVisible.mppd && (
          <div className="project-section">
            ...
            <img src={imageTest} alt="MPPD project icon" />
            <p>
